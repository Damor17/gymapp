...
import styles from "./monthlygoalsstyles";
...
const MonthlyGoals = () => {
    ...
    const targeted = null
    const [monthlygoals, setmonthlygoals] = useState( [['Be Leaner'],
    ['Be Stronger'], 
    ['Start training more'],
    ['Be Him']])
    ...
    const handleDelete =(id) => {
        const mgoals = monthlygoals.filter((_, idx) => idx !== id)
    ...
    const handleAdd = () => {
        ...
        setmonthlygoals((monthlygoals) => [...monthlygoals, newGoal])
    ...
    return (
        ...
        start={{x:1, y:0}}
            ...
            <View style={styles.headerTextContainer}>
                <Text style={styles.headerText}> Monthly Goals: </Text>
